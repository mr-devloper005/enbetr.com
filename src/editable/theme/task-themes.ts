...
const YELP_FONT = "'DM Sans', system-ui, -apple-system, Arial, sans-serif"
...
export const taskThemes: Record<TaskKey, TaskTheme> = {
  ...
  classified: { ...base, kicker: 'Enbetr Classifieds', note: 'Buy, sell, hire, rent, and offer services with clarity.' },
  ...
  profile: { ...base, kicker: 'Enbetr Profiles', note: 'Discover credible people, organizations, and professional expertise.' },
}
