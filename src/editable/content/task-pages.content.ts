...
export const taskPageVoices = {
  ...
  classified: {
    eyebrow: 'Enbetr marketplace',
    headline: 'Find the right product, service, role, or opportunity.',
    description: 'Browse practical classifieds for buying, selling, hiring, renting, and offering services, with the important details easy to scan.',
  ...
  profile: {
    ...
    headline: 'Meet people and organizations with something valuable to offer.',
    description: 'Discover profiles that clearly present expertise, experience, services, and identity so every connection begins with useful context.',
